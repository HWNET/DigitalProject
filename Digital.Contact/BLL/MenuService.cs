    ...
    public class MenuService
    {
        ...
        public List<MenuModel> MenuList()
        {
            ...
            var Menus = new List<MenuModel> { 
                ...
                new MenuModel{ID=100 ,MenuName="账户中心",Style="glyphicon glyphicon-info-sign",OtherName="",ParentId=100,Url="../Company/IndexAccount"},
                new MenuModel{ID=101 ,MenuName="账户信息",Style="glyphicon glyphicon-info-sign",OtherName="",ParentId=100,Url="../Company/AccountInfo"},
                new MenuModel{ID=102 ,MenuName="子账户管理",Style="glyphicon glyphicon-info-sign",OtherName="",ParentId=100,Url="../Company/AccountSubUserManage"},
                new MenuModel{ID=103 ,MenuName="账户安全",Style="glyphicon glyphicon-info-sign",OtherName="",ParentId=100,Url="../Company/AccountSecurity"},
                new MenuModel{ID=104 ,MenuName="交易资料",Style="glyphicon glyphicon-info-sign",OtherName="",ParentId=100,Url="../Company/AccountTransactionInfo"},

                new MenuModel{ID=150 ,MenuName="企业信息中心",Style="glyphicon  glyphicon-user",OtherName="",ParentId=150,Url="../Company/CompanyIndex"},
                new MenuModel{ID=151 ,MenuName="基础信息",Style="glyphicon glyphicon-info-sign",OtherName="",ParentId=150,Url="../Company/CompanyBaseInfo"},
                new MenuModel{ID=152 ,MenuName="资质介绍",Style="glyphicon glyphicon-info-sign",OtherName="",ParentId=150,Url="../Company/CompanyQualificationCertificateList"},
                new MenuModel{ID=153 ,MenuName="企业信誉",Style="glyphicon glyphicon-info-sign",OtherName="",ParentId=150,Url="../Company/CompanyCredibility"},
                new MenuModel{ID=154 ,MenuName="企业文件柜",Style="glyphicon glyphicon-info-sign",OtherName="",ParentId=150,Url="../Company/CompanyFiles"},
                new MenuModel{ID=155 ,MenuName="上传图片",Style="glyphicon glyphicon-info-sign",OtherName="",ParentId=150,Url="../Company/CompanyPictureUpload"},
                new MenuModel{ID=156 ,MenuName="添加企业案例",Style="glyphicon glyphicon-info-sign",OtherName="",ParentId=150,Url="../Company/CompanyCasesAdd"},
                new MenuModel{ID=157 ,MenuName="企业案例分类管理",Style="glyphicon glyphicon-info-sign",OtherName="",ParentId=150,Url="../Company/CompanyCasesClassManage"},
                new MenuModel{ID=158 ,MenuName="企业案例列表",Style="glyphicon glyphicon-info-sign",OtherName="",ParentId=150,Url="../Company/CompanyCasesList"},
                ...
                new MenuModel{ID=161 ,MenuName="案例列表",Style="glyphicon glyphicon-info-sign",OtherName="",ParentId=150,Url="../Company/CompanyPatentList"},
                new MenuModel{ID=162 ,MenuName="添加企业案例",Style="glyphicon glyphicon-info-sign",OtherName="",ParentId=150,Url="../Company/CompanyPatentAdd"},
                ...
                new MenuModel{ID=166 ,MenuName="水印设置",Style="glyphicon glyphicon-info-sign",OtherName="",ParentId=150,Url="../Company/CompanyWatermarkManage"},
                ...
                new MenuModel{ID=250 ,MenuName="项目部",Style="fa fa-building",OtherName="我的项目",ParentId=250,Url="../Company/"},
                new MenuModel{ID=251 ,MenuName="发布项目",Style="fa fa-mail-forward",OtherName="",ParentId=250,Url="../Company/ProjectPublish"},
                new MenuModel{ID=252 ,MenuName="已发布项目",Style="fa fa-mail-forward",OtherName="",ParentId=250,Url="../Company/ProjectPublishedList"},
                new MenuModel{ID=253 ,MenuName="合作中的项目",Style="fa fa-thumbs-o-up",OtherName="",ParentId=250,Url="../Company/ProjectCooperationList"},
                new MenuModel{ID=254 ,MenuName="供应商收藏夹",Style="fa fa-tasks",OtherName="",ParentId=250,Url="../Company/ProjectSupplierManage"},
                new MenuModel{ID=255 ,MenuName="评估书协助",Style="fa fa-thumb-tack",OtherName="",ParentId=250,Url="../Company/ProjectHelpAssessment"},
                new MenuModel{ID=256 ,MenuName="发布众筹",Style="fa fa-thumb-tack",OtherName="",ParentId=250,Url="../Company/ProjectCrowdfundingPublish"},
                new MenuModel{ID=257 ,MenuName="已发布众筹项目列表",Style="fa fa-thumb-tack",OtherName="",ParentId=250,Url="../Company/ProjectCrowdfundingList"},


                new MenuModel{ID=300 ,MenuName="业务部",Style="glyphicon glyphicon-phone-alt",OtherName="",ParentId=300,Url="../Company/"},
                new MenuModel{ID=301 ,MenuName="收藏的定制需求",Style="fa fa-send",OtherName="",ParentId=300,Url="../Company/SalesMyGetShort-listedProject"},
                new MenuModel{ID=302 ,MenuName="发送项目评估书",Style="fa fa-sort-amount-desc",OtherName="",ParentId=300,Url="../Company/SalesSendProjectEvaluation"},
                new MenuModel{ID=303 ,MenuName="发送报价单",Style="fa fa-sort-amount-desc",OtherName="",ParentId=300,Url="../Company/SalesQuotationPublish"},
                new MenuModel{ID=309 ,MenuName="访客记录",Style="fa fa-sort-amount-desc",OtherName="",ParentId=300,Url="../Company/SalesCustomerVisitor"},
                new MenuModel{ID=304 ,MenuName="询盘管理",Style="fa fa-send",OtherName="",ParentId=300,Url="../Company/SalesCustomerVisitor"},
                new MenuModel{ID=305 ,MenuName="发布产品",Style="fa fa-send",OtherName="",ParentId=300,Url="../Company/SalesProductsAdd"},
                new MenuModel{ID=307 ,MenuName="产品分类管理",Style="fa fa-star",OtherName="",ParentId=300,Url="../Company/"},
                new MenuModel{ID=308 ,MenuName="已发布产品管理",Style="fa fa-star-o",OtherName="",ParentId=300,Url="../Company/"},
                new MenuModel{ID=311 ,MenuName="发布招商",Style="fa fa-sort-amount-desc",OtherName="",ParentId=300,Url="../Company/SalesDistributionChannelPublish"},
                new MenuModel{ID=311 ,MenuName="加盟商列表",Style="fa fa-sort-amount-desc",OtherName="",ParentId=300,Url="../Company/SalesDistributionChannelIndex"},
                new MenuModel{ID=311 ,MenuName="在线客服",Style="fa fa-sort-amount-desc",OtherName="",ParentId=300,Url="../Company/SalesOnlineManage"},
                new MenuModel{ID=307 ,MenuName="待收款",Style="fa fa-star",OtherName="",ParentId=300,Url="../Company/SalesNeedCollect"},
                new MenuModel{ID=307 ,MenuName="订单管理",Style="fa fa-star",OtherName="",ParentId=300,Url="../Company/SalesOrderList"},
